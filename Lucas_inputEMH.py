...
class PlayButton(Sprite):
    ...
    def on_left_click(self):
        ...
        window.create_sprite(MediumButton)
        window.create_sprite(HardButton)
...
class MediumButton(Sprite):
    def on_create(self):
        self.image = 'med.png'  # reuse image or replace
        self.scale = 3
...
class HardButton(Sprite):
    def on_create(self):
        self.image = 'hard.png'  # reuse image or replace
        self.scale = 3
        self.position = Point(840, 480)
